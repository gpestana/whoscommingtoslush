...
//      console.log(navs);
      ...
      //2 and 5
      if(data.hits.length > 1) data.hits.splice(1, 0, {'document':{'desc':'random','us':'on'}})
      if(data.hits.length > 5) data.hits.splice(5, 0, {'document':{'desc':'random','us':'on'}})
      if(data.hits.length > 10) data.hits.splice(10, 0, {'document':{'desc':'random','us':'on'}})
...
app.config(['$routeProvider',
  function($routeProvider) {
    $routeProvider.
      ...
      when('/help-us', {templateUrl: '/partials/help-us.html'}).
